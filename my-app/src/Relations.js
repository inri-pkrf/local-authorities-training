...
function Relations() {
    ...
    const [step1Color, setStep1Color] = useState('#f2903f'); // Initial color for step 1 button
    const [step2Color, setStep2Color] = useState('rgb(145 85 35)'); // Initial color for step 2 button
    const [step3Color, setStep3Color] = useState('rgb(145 85 35)'); // Initial color for step 3 button
    ...
    const handleClick = (item) => {
        ...
        setStep1Color('#f2903f');
        setStep2Color('#f2903f'); // Change color of Step 2 button
    };
    ...
    const handleStepClick = (stepNumber) => {
        if (stepNumber === 1) {
            ...
            setStep1Color('#f2903f'); // Reset color for Step 1
            setStep2Color('rgb(145 85 35)'); // Reset color for Step 2
            setStep3Color('rgb(145 85 35)'); // Reset color for Step 3
            ...
            setStep(2);
            setStep2Color('#f2903f'); // Highlight Step 2 button
            ...
            setStep(3);
            setStep3Color('#f2903f'); // Highlight Step 3 button
