...
const cardData = [
  {
    ...
    title: 'ראש רשות/ רמ"ט',
    headline: '1. ראש רשות/ רמ"ט',
    text: (
      <>
        <b>תפקיד ראש הרשות/ רמ"ט בהערכת מצב:</b>
        <br /> <br />
  ...
  },
  {
    ...
    text: (<><b>תפקיד המכלול בהערכת מצב:</b>
      ...
      <b>תמונת מצב צרכי התושבים –</b> מפלטפורמות (המוקד הטלפוני הרשותי, אתר האינטרנט הרשותי, דף פייסבוק ויתר רשתות חברתיות)
      הרשות: פילוח פניות ע"פ נושאים
      וקהלי יעד.
      <br />
      <b>תמונת מצב מימוש תוכנית ההסברה</b> היומית שסוכמה.
      <br />
  ...
  },
  {
    ...
    text: (<>
      ראש הרשות יגדיר את סדר העדיפות, יתן הנחיות לביצוע ומשימות לתכנון.
    </>),
    video: '/ass1.mp4'
  },
